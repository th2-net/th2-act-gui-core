...
public class FindElementBuilder extends WebDefaultBuilder<FindElementBuilder> {
	...
	@Override
	protected FindElementBuilder getBuilder() {
		return this;
	}
	...
	public FindElementBuilder id(String id) {
		this.id = id;
		return this;
	}
