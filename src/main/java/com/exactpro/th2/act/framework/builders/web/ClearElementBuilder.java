...
public class ClearElementBuilder extends AbstractWebBuilder<ClearElementBuilder> {
	
	protected ClearElementBuilder(UIWebFrameworkContext context) {
		super(context);
	}

	@Override
	protected ClearElementBuilder getBuilder() {
		return this;
	}
	...
	protected RhWebActions buildAction() throws UIFrameworkBuildingException {
		...
		RhActionsMessages.ClearElement.Builder builder = RhActionsMessages.ClearElement.newBuilder();
		...
		return RhWebActions.newBuilder().setClearElement(builder).build();
	}
}
