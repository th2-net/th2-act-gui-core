...
public class CheckImageAvailabilityBuilder extends AbstractWebBuilder<CheckImageAvailabilityBuilder> {
	
	protected CheckImageAvailabilityBuilder(UIWebFrameworkContext context) {
		super(context);
	}

	@Override
	protected CheckImageAvailabilityBuilder getBuilder() {
		return this;
	}
	...
	protected RhWebActions buildAction() throws UIFrameworkBuildingException {
		...
		RhActionsMessages.CheckImageAvailability.Builder builder = RhActionsMessages.CheckImageAvailability.newBuilder();
		...
		return RhWebActions.newBuilder().setCheckImageAvailability(builder).build();
	}
}
