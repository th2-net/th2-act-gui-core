...
public class UIWebFrameworkContext extends UIFrameworkContext<RhActionsMessages.RhWebActions> {

	public UIWebFrameworkContext(RhSessionID sessionID, HandExecutor handExecutor) {
