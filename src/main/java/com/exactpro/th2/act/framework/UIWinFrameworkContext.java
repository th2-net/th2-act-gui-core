...
public class UIWinFrameworkContext extends UIFrameworkContext<RhWinActionsMessages.RhWinActions> {

	public UIWinFrameworkContext(RhSessionID sessionID, HandExecutor handExecutor) {
